...
pub enum Status {
    ...
    SET_ON_ACTIVE_PROCESS = 36,
    INVALID_SURFACE = 37,
    NO_DEVICE = 38,
    ECC_UNCORRECTABLE = 39,
    SHARED_OBJECT_SYMBOL_NOT_FOUND = 40,
    SHARED_OBJECT_INIT_FAILED = 41,
    UNSUPPORTED_LIMIT = 42,
    DUPLICATE_VARIABLE_NAME = 43,
    DUPLICATE_TEXTURE_NAME = 44,
    DUPLICATE_SURFACE_NAME = 45,
    DEVICES_UNAVAILABLE = 46,
    INVALID_KERNEL_IMAGE = 47,
    NO_KERNEL_IMAGE_FOR_DEVICE = 48,
    INCOMPATIBLE_DRIVER_CONTEXT = 49,
    PEER_ACCESS_ALREADY_ENABLED = 50,
    PEER_ACCESS_NOT_ENABLED = 51,
    DEVICE_ALREADY_IN_USE = 54,
    PROFILER_DISABLED = 55,
    PROFILER_NOT_INITIALIZED = 56,
    PROFILER_ALREADY_STARTED = 57,
    PROFILER_ALREADY_STOPPED = 58,
    ASSERT = 59,
    TOO_MANY_PEERS = 60,
    HOST_MEMORY_ALREADY_REGISTERED = 61,
    HOST_MEMORY_NOT_REGISTERED = 62,
    OPERATING_SYSTEM = 63,
    PEER_ACCESS_UNSUPPORTED = 64,
    ...
    NOT_PERMITTED = 70,
    NOT_SUPPORTED = 71,
    HARDWARE_STACK_ERROR = 72,
    ILLEGAL_INSTRUCTION = 73,
    MISALIGNED_ADDRESS = 74,
    INVALID_ADDRESS_SPACE = 75,
    INVALID_PC = 76,
    ILLEGAL_ADDRESS = 77,
    INVALID_PTX = 78,
    INVALID_GRAPHICS_CONTEXT = 79,
    STARTUP_FAILURE = 0x7f,
