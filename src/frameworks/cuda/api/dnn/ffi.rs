...
use frameworks::cuda::api::DriverFFI::*;
...
extern "C" {
    ...
    pub fn cudnnSetStream(handle: cudnnHandle_t, streamId: CUstream) -> cudnnStatus_t;

    pub fn cudnnGetStream(handle: cudnnHandle_t, streamId: *mut CUstream) -> cudnnStatus_t;
