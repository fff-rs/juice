...
pub const CUDART_VERSION: u32 = 10020;
...
pub type cudaStreamCaptureStatus = i32;
...
pub type cudaStreamCaptureMode = i32;
...
pub type cudaExternalMemoryHandleType = i32;
...
pub type cudaExternalSemaphoreHandleType = i32;
...
pub type cudaGraphNodeType = i32;
...
pub type cudaGraphExecUpdateResult = i32;
...
extern "C" {
    ...
    #[doc = " can be used to create an NvSciSync that matches this device\u{2019}s capabilities."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " Returns cudaErrorInvalidValue if the memory operands\u{2019} mappings changed or"]
...
extern "C" {
    ...
    #[doc = " not modified by this call."]
    #[doc = ""]
    #[doc = " Returns cudaErrorInvalidValue if the memory operand\u{2019}s mappings changed or"]
...
extern "C" {
    ...
    #[doc = "   the node\u{2019}s type or configuration, in which case \\p hErrorNode_out is set to the node from \\p hGraph"]
    #[doc = ""]
    #[doc = " If \\p updateResult_out isn\u{2019}t set in one of the situations described above, the update check passes"]
