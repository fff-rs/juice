...
fn bindgen_test_layout_cudnnConvolutionBwdFilterAlgoPerf_t() {
    ...
    assert_eq!(
        unsafe { &(*(0 as *const cudnnConvolutionBwdFilterAlgoPerf_t)).status as *const _ as usize },
        4usize,
        concat!(
            "Alignment of field: ",
            stringify!(cudnnConvolutionBwdFilterAlgoPerf_t),
    ...
    assert_eq!(
        unsafe { &(*(0 as *const cudnnConvolutionBwdFilterAlgoPerf_t)).memory as *const _ as usize },
        16usize,
        concat!(
            "Alignment of field: ",
            stringify!(cudnnConvolutionBwdFilterAlgoPerf_t),
    ...
    assert_eq!(
        unsafe { &(*(0 as *const cudnnConvolutionBwdFilterAlgoPerf_t)).mathType as *const _ as usize },
        28usize,
        concat!(
            "Alignment of field: ",
            stringify!(cudnnConvolutionBwdFilterAlgoPerf_t),
    ...
    assert_eq!(
        unsafe { &(*(0 as *const cudnnConvolutionBwdFilterAlgoPerf_t)).reserved as *const _ as usize },
        32usize,
        concat!(
            "Alignment of field: ",
            stringify!(cudnnConvolutionBwdFilterAlgoPerf_t),
...
fn bindgen_test_layout_cudnnConvolutionBwdDataAlgoPerf_t() {
    ...
    assert_eq!(
        unsafe { &(*(0 as *const cudnnConvolutionBwdDataAlgoPerf_t)).determinism as *const _ as usize },
        24usize,
        concat!(
            "Alignment of field: ",
            stringify!(cudnnConvolutionBwdDataAlgoPerf_t),
    ...
    assert_eq!(
        unsafe { &(*(0 as *const cudnnConvolutionBwdDataAlgoPerf_t)).mathType as *const _ as usize },
        28usize,
        concat!(
            "Alignment of field: ",
            stringify!(cudnnConvolutionBwdDataAlgoPerf_t),
    ...
    assert_eq!(
        unsafe { &(*(0 as *const cudnnConvolutionBwdDataAlgoPerf_t)).reserved as *const _ as usize },
        32usize,
        concat!(
            "Alignment of field: ",
            stringify!(cudnnConvolutionBwdDataAlgoPerf_t),
